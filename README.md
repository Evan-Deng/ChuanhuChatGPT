...
<h1 align="center">昊达 Chat 🐯 Haoda Chat</h1>
<div align="center">
  <a href="https://github.com/Evan-Deng/ChuanhuChatGPT">
    <img src="https://github.com/Evan-Deng/ChuanhuChatGPT/assets/70903329/aca3a7ec-4f1d-4667-890c-a6f47bf08f63" alt="Logo" height="156">
  </a>

<p align="center">
    <h3>为ChatGPT等多种LLM提供了一个轻快好用的Web图形界面和众多附加功能</h3>
    <p align="center">
      <a href="https://github.com/Evan-Deng/ChuanhuChatGPT/blob/main/LICENSE">
        <img alt="Tests Passing" src="https://img.shields.io/github/license/Evan-Deng/ChuanhuChatGPT" />
      </a>
...
| [支持模型](#支持模型) | [使用技巧](#使用技巧) | [安装方式](https://github.com/Evan-Deng/ChuanhuChatGPT/wiki/使用教程) | [常见问题](https://github.com/Evan-Deng/ChuanhuChatGPT/wiki/常见问题) | [给作者买可乐🥤](#捐款) |
| --- | --- | --- | --- | --- |

## ✨ 5.0 重磅更新！

![ChuanhuChat5更新](https://github.com/Evan-Deng/ChuanhuChatGPT/assets/70903329/f2c2be3a-ea93-4edf-8221-94eddd4a0178)
...
```shell
git clone https://github.com/Evan-Deng/ChuanhuChatGPT.git
cd ChuanhuChatGPT
...
> **Note**
>
> 具体详尽的安装教程和使用教程请查看[本项目的wiki页面](https://github.com/Evan-Deng/ChuanhuChatGPT/wiki/使用教程)。
...
1. 点击网页上的 `Download ZIP` 按钮，下载最新代码并解压覆盖，或
   ```shell
   git pull https://github.com/Evan-Deng/ChuanhuChatGPT.git main -f
   ```
